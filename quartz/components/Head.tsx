...
async function generateSocialImage(
	...
	const compressed = await sharp(Buffer.from(svg))
		.webp({ quality: 40 })
		.toBuffer();
...
export default (() => {
	...
	const Head: QuartzComponent = ({
		...
		const iconMaskPath = joinSegments(baseDir, "static/apple-touch-icon.png");
		...
		return (
			<head>
				...
				<link rel="icon" href={iconPath} sizes="32x32" />
				<link rel="apple-touch-icon" href={iconMaskPath} />
