import {METHOD, METHODS, NEXT_PUBLIC_SERVER_URL, URLS} from "@/libs/constant/api.const";
...
export async function limcFetch(url: string, method: METHOD, isAdmin: boolean, body?: any) {
